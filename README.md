...
🛠️ Atualmente, na Mei Mei, atuo com automações, integrações entre sistemas, apoio à infraestrutura tecnológica em inaugurações de lojas, suporte a equipamentos e demandas tecnológicas do escritório da franqueadora.
...
- Redes TCP/IP;
- Linux;
- Pentest básico em ambientes controlados;
